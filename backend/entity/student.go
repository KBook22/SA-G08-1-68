...
type Student struct {
    ...
    Year int `gorm:"not null" json:"year"`
    Faculty string `gorm:"type:varchar(255);not null" json:"faculty"`
    Department string `gorm:"type:varchar(255)" json:"department"` // เพิ่มฟิลด์นี้
    Phone string `gorm:"type:varchar(20);not null" json:"phone"`
    Skills string `json:"skills"`
    ProfileImageURL string `gorm:"type:varchar(500)" json:"profile_image_url"` // เพิ่มฟิลด์นี้
